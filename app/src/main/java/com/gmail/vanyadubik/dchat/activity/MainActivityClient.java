	...
	OnClickListener buttonConnectOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (textUserName.equals("")) {
				Toast.makeText(MainActivityClient.this, "Enter User Name",
			...
			if (textAddress.equals("")) {
				Toast.makeText(MainActivityClient.this, "Enter Addresse",
						Toast.LENGTH_LONG).show();
				return;
			}
		...
		public void run() {
			...
			try {
                ...
                MainActivityClient.this.runOnUiThread(new Runnable() {
					...
					@Override
					public void run() {
						Toast.makeText(MainActivityClient.this, eString, Toast.LENGTH_LONG).show();
					}
